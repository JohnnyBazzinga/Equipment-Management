...
var skel=function(){
  var _={
    ...
    unreverseRows:function(){
      var e="_skel_isReversed",t=_.getElementsByClassName("row");_.iterate(t,function(n){
        if(n==="length")return;
        var r=t[n];
        if(!r[e])return;
        var i=r.children,s;
    ...
    reverseRows:function(e){
      ...
      _.iterate(n,function(r){
        ...
        var s=i.children,o;
        for(o=1;o<s.length;o++)i.insertBefore(s[o],s[0]);i[t]=!0
      })
    },
    bind:function(e,t){
    ...
    trigger:function(e){
      ...
      var n;_.iterate(_[t][e],function(n){
        _[t][e][n]()
      })
    },
    ...
    registerLocation:function(e,t){
      var n="_skel_attach",r="appendChild";e=="head"?t[n]=function(e){
    ...
    cacheBreakpointElement:function(e,t,n,r,i){
      var s="breakpoints",o=_.getCachedElement(t);return o||(o=_.cacheElement(t,n,r,i)),_[s][e]&&_[s][e].elements.push(o),o},getCachedElement:function(e){
    ...
    attachElements:function(e){
          ...
          _[t](e,function(t){
              s[e[t][n]]||(s[e[t][n]]=[]),s[e[t][n]].push(e[t])}),_[t](s,function(e){
    ...
    changeState:function(e){
      ...
      if(!_[i][r][_[n]]){_[i][r][_[n]]={config:{},elements:[],values:{}},F=_[i][r][_[n]],_[n]===_.sd?B=[]:B=_[n].substring(1).split(_.sd),_.extend(F[s],_.defaults.config_breakpoint),_[o](B,function(e){
        _.extend(F[s],_[u][B[e]][s])}),_[s].boxModel&&(R="iBM",(q=_[a](R))||(q=_[f](R,_[l]("*,*:before,*:after{-moz-@;-webkit-@;@}".replace(/@/g,"box-sizing:"+_[s].boxModel+"-box")),c,3)),F[p][h](q)),_[s].resetCSS?(R="iR",(q=_[a](R))||(q=_[f](R,_[l](_.css.r),c,2)),F[p][h](q)):_[s].normalizeCSS&&(R="iN",(q=_[a](R))||(q=_[f](R,_[l](_.css.n),c,2)),F[p][h](q)),_[s][d]&&(R="ssB",(q=_[a](R))||(q=_[f](R,_[v](_[s][d]+m),c,4)),F[p][h](q)),U=F[s][g],F[s][y]?U+=(U!=""?b:"")+"width="+F[s][y]:F[s][w]&&(U+=(U!=""?b:"")+"width=device-width"),F[s][w]&&(U+=(U!=""?b:"")+"initial-scale=1.0,minimum-scale=1.0,maximum-scale=1.0"),U!=""&&(R="mV"+_[n],(q=_[a](R))||(q=_[f](R,_.newMeta(g,U),c,1)),F[p][h](q)),_[t].IEVersion>=10&&(R="mVIE"+_[n],(q=_[a](R))||(q=_[f](R,_[l]("@-ms-viewport{width: device-width}"),c,2)),F[p][h](q));
                           ...
                           if(!(q=_[a](R))){
                             ...
                             switch(nt){
                               ...
                               case 2:U+=":not(.no-collapse-2):not(.no-collapse-3)";
                                 break;
                               case 1:
                               default:U+=":not(.no-collapse-1):not(.no-collapse-2):not(.no-collapse-3)"
                             }
                         ...
                         R="iCd"+_[n];
                         if(!(q=_[a](R))){U=[],z=[],_[o](_[u],function(e){
                           _.indexOf(B,e)!==-1?U[h](".not-"+e):z[h](".only-"+e)
                         });
                         var rt=(U[A]>0?U.join(b)+O:"")+(z[A]>0?z.join(b)+O:"");
                                          q=_[f](R,_[l](rt.replace(/\.([0-9])/,".\\3$1 ")),c,3),F[p][h](q)}_[o](B,function(e){
      ...
      return t.rel="stylesheet",t.type="text/css",t.href=e,t},newInline:function(e){
        ...
        _.plugins[e]=t,t._=this,_.isConfigured&&(_.initPluginConfig(e,_.plugins[e]),t.init())},initPluginConfig:function(id,o){
          ...
          window._skel_config?s=window._skel_config:(s=_.me.innerHTML.replace(/^\s+|\s+$/g,""),s&&(s=eval("("+s+")"))),function(){
            ...
            typeof s==e&&(s[t]&&_.presets[s[t]]?(_[r][n]={},_[i](_[r],_.presets[s[t]]),_[i](_[r],s)):(s[n]&&(_[r][n]={}),_[i](_[r],s))),_[i](_[u][o].grid,_[r].grid),_[u][o][a]=_[r][a],_.iterate(_[r][n],function(t){
              typeof _[r][n][t]!=e&&(_[r][n][t]={
                range:_[r][n][t]
              }),c={},_[i](c,_[u][o]),_[i](c,_[r][n][t]),_[r][n][t]=c,b={},_[i](b,_[u].breakpoint),b[r]=_[r][n][t],b.test=buildTest(t,b[r].range),b.elements=[],_[n][t]=b,_[r].preloadStyleSheets&&b[r].hasStyleSheet&&preloads.push(_[r].prefix+"-"+t+".css"),_.breakpointList.push(t)}),_.iterate(_[r].events,function(e){
          ...
          var e;_.config.pollOnce||(window.onresize=function(){
            ...
            var e="addEventListener",t="domready",n="DOMContentLoaded",r="readyState",i="removeEventListener",s="getElementsByClassName",o="querySelectorAll",u="indexOf";document[e]?!function(e,t){
              _.DOMReady=t()
            }(t,function(){
              function t(e){
                f=1;
                while(e=s.shift())e()
                  }var s=[],o,u=document,a=n,f=/^loaded|^c/.test(u[r]);return u[e](a,o=function(){
                    u[i](a,o),t()
                  }),function(e){
                    f?e():s.push(e)
                  }
              ...
              return f[p]&&f[p](h,u=function(){
                f[i](h,u,a),s()},a),c&&f.attachEvent(d,u=function(){
                /^c/.test(f[m])&&(f.detachEvent(d,u),s())}),t=c?function(e){
              ...
              if(!e)return[];
              var n;
              for(n in e)Object.prototype.hasOwnProperty.call(e,n)&&t(n)}},initAPI:function(){
                ...
                if(t){
                  ...
                  _[n](o,document[i](o)[0])}),_.initEvents(),_.poll();
                var a;
